...
export const SendMoneyModal: React.FC<SendMoneyModalProps> = ({ 
  ...
  const handleWalletTransfer = async () => {
    ...
    try {
      ...
      const newBalance = data.newBalance || (walletBalance - numericAmount);
      ...
      toast({
        title: "✅ Money Sent!",
        description: `KES ${numericAmount.toLocaleString()} sent to ${recipient}. New balance: KES ${newBalance.toLocaleString()}`,
      });
