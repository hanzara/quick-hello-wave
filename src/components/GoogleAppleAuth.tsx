  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      toast({
        ...
        description: error.message || "Failed to sign in with Google. Please ensure Google auth is enabled in Supabase.",
        variant: "destructive",
      });
    }
  };
  ...
  const handleAppleSignIn = async () => {
    try {
      ...
      toast({
        ...
        description: "Please complete sign in with Apple",
      });
    } catch (error: any) {
      console.error('Apple sign in error:', error);
      toast({
        title: "Apple Sign In Failed", 
        description: error.message || "Failed to sign in with Apple. Please ensure Apple auth is enabled in Supabase.",
        variant: "destructive",
      });
    }
  };
